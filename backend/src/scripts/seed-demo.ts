...
const demoPatients = [
  {
    ...
    medicalHistory: [
      { date: "2005-01-20", record: "Diagnosed with asthma since childhood" },
      { date: "2024-06-10", record: "Mild allergic reaction to dust and pollen" },
    ],
  ...
  },
  {
    ...
    medicalHistory: [
      { date: "2019-03-14", record: "Hypertension (borderline), on low-salt diet" },
    ],
    allergies: null,
  ...
  },
  {
    ...
    medicalHistory: [
      { date: "2021-09-02", record: "Type 2 diabetes, high cholesterol" },
    ],
  ...
  },
  {
    ...
    medicalHistory: [
      { date: "2015-11-18", record: "Hypertension" },
      { date: "2022-02-09", record: "Knee arthritis (both knees)" },
    ],
    allergies: "Aspirin",
