...
import { registerQuickAddRoutes } from "@/clinic/modules/quick-add/quick-add.routes";
...
import { registerPharmacyRoutes } from "@/clinic/modules/pharmacy/pharmacy.routes";
...
export function registerClinicApi(app: FastifyInstance): void {
  ...
  app.register(async (tenantApi) => {
    ...
    registerQuickAddRoutes(tenantApi);
