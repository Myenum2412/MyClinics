      ...
      },
      {
        ...
        headers: [
          ...
          { key: "Strict-Transport-Security", value: "max-age=31536000; includeSubDomains; preload" },
          {
            ...
            value: [
              "default-src 'self'",
              // SEC-008: removed 'unsafe-eval' (not needed for Next/Tailwind). Kept 'unsafe-inline' for Next hydration + Tailwind, scoped.
              "script-src 'self' 'unsafe-inline' https://*.myenum.in https://www.googletagmanager.com https://www.google-analytics.com https://*.googletagmanager.com",
