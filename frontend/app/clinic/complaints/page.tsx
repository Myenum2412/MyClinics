  ...
  return <div className="space-y-4">
    <div className="rounded-xl border bg-card p-5 space-y-4">
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        ...
        <div><Label className="text-xs">Severity</Label><Select value={v["Severity"]} onValueChange={val=>SV("Severity", val)}><SelectTrigger className="mt-1 h-9"><SelectValue placeholder="Select severity"/></SelectTrigger><SelectContent><SelectItem value="mild">Mild</SelectItem><SelectItem value="moderate">Moderate</SelectItem><SelectItem value="severe">Severe</SelectItem></SelectContent></Select></div>
        ...
        <div><Label className="text-xs">Frequency</Label><Select value={v["Frequency"]} onValueChange={val=>SV("Frequency", val)}><SelectTrigger className="mt-1 h-9"><SelectValue placeholder="Select frequency"/></SelectTrigger><SelectContent><SelectItem value="once">Once</SelectItem><SelectItem value="intermittent">Intermittent</SelectItem><SelectItem value="continuous">Continuous</SelectItem></SelectContent></Select></div>
        ...
        <div><Label className="text-xs">Priority</Label><Select value={v["Priority"]} onValueChange={val=>SV("Priority", val)}><SelectTrigger className="mt-1 h-9"><SelectValue placeholder="Select priority"/></SelectTrigger><SelectContent><SelectItem value="Low">Low</SelectItem><SelectItem value="Medium">Medium</SelectItem><SelectItem value="High">High</SelectItem><SelectItem value="Emergency">Emergency</SelectItem></SelectContent></Select></div>
      </div>
  ...
  return <div className="space-y-4">
    <div className="rounded-xl border bg-card p-5 space-y-4">
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        ...
        <div><Label className="text-xs">Patient Consent</Label><Select value={v["Patient Consent"]} onValueChange={val=>SV("Patient Consent", val)}><SelectTrigger className="mt-1 h-9"><SelectValue placeholder="Select consent"/></SelectTrigger><SelectContent><SelectItem value="Yes">Yes</SelectItem><SelectItem value="No">No</SelectItem><SelectItem value="Pending">Pending</SelectItem></SelectContent></Select></div>
      </div>
  ...
  return <div className="space-y-4">
    <div className="rounded-xl border bg-card p-5 space-y-4">
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        ...
        <div><Label className="text-xs">Condition at Discharge</Label><Select value={v["Condition at Discharge"]} onValueChange={val=>SV("Condition at Discharge", val)}><SelectTrigger className="mt-1 h-9"><SelectValue placeholder="Select condition"/></SelectTrigger><SelectContent><SelectItem value="Stable">Stable</SelectItem><SelectItem value="Improved">Improved</SelectItem><SelectItem value="Critical">Critical</SelectItem></SelectContent></Select></div>
        ...
        <div><Label className="text-xs">Patient / Attendant Acknowledgement</Label><Select value={v["Patient / Attendant Acknowledgement"]} onValueChange={val=>SV("Patient / Attendant Acknowledgement", val)}><SelectTrigger className="mt-1 h-9"><SelectValue placeholder="Select"/></SelectTrigger><SelectContent><SelectItem value="Acknowledged">Acknowledged</SelectItem><SelectItem value="Pending">Pending</SelectItem></SelectContent></Select></div>
      </div>
