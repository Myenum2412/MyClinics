  ...
  return <div className="space-y-4">
    <div className="rounded-xl border bg-card p-5 space-y-4">
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        ...
        <div><Label className="text-xs">Complaint Category</Label><select value={v["Complaint Category"]} onChange={e=>SV("Complaint Category", e.target.value)} className="mt-1 h-9 w-full rounded-lg border border-input bg-background px-3 text-sm"><option value="">Select category</option><option value="treatment">treatment</option><option value="staff">staff</option><option value="billing">billing</option><option value="facility">facility</option><option value="other">other</option></select></div>
