...
export const metadata: Metadata = {
  ...
  description: "Record supplier purchases and costs.",
};
export default function Page() {
  return (
    <div className="px-6 py-10 lg:px-10">
      <h1 className="font-heading text-3xl font-bold tracking-tight">Purchases</h1>
      <p className="mt-3 max-w-2xl text-muted-foreground">Record supplier purchases and costs.</p>
      <div className="mt-8">
        <h2 className="text-lg font-semibold">How to create / use Purchases</h2>
        <ol className="mt-3 list-decimal space-y-2 pl-5 text-sm leading-relaxed text-foreground/90">
          <li>Open Purchases → New Purchase → select Supplier → add medicines, qty and rate.</li><li>Example: MediSupplier — 200 strips @ ₹10 → total ₹2,000 — stock increases automatically.</li><li>Save invoice — tracks spending and updates inventory.</li>
        </ol>
      </div>
      ...
      <div className="mt-4 rounded-lg border px-4 py-3 text-sm">
        <span className="font-semibold">Tip:</span> Open this from the app sidebar → Purchases. If you do not see it, your role may not have access — ask your clinic admin.
      </div>
    </div>
  );
}
