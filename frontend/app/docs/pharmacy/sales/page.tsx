...
export const metadata: Metadata = {
  ...
  description: "Dispense medicines and auto-update stock.",
};
export default function Page() {
  return (
    <div className="px-6 py-10 lg:px-10">
      <h1 className="font-heading text-3xl font-bold tracking-tight">Sales</h1>
      <p className="mt-3 max-w-2xl text-muted-foreground">Dispense medicines and auto-update stock.</p>
      <div className="mt-8">
        <h2 className="text-lg font-semibold">How to create / use Sales</h2>
        <ol className="mt-3 list-decimal space-y-2 pl-5 text-sm leading-relaxed text-foreground/90">
          <li>Open Sales → New Sale → select patient/medicines and quantity.</li><li>Confirm — stock reduces instantly, bill is generated and linked to the patient.</li><li>Example: sale of 2 strips → stock 100→98, bill created.</li>
        </ol>
      </div>
      ...
      <div className="mt-4 rounded-lg border px-4 py-3 text-sm">
        <span className="font-semibold">Tip:</span> Open this from the app sidebar → Sales. If you do not see it, your role may not have access — ask your clinic admin.
      </div>
    </div>
  );
}
