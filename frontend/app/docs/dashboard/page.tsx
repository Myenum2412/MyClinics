...
export const metadata: Metadata = {
  title: "Dashboard — My Clinics Docs",
  description: "Your clinic overview at a glance — today's appointments, revenue, and pending tasks.",
};
export default function Page() {
  return (
    <div className="px-6 py-10 lg:px-10">
      <h1 className="font-heading text-3xl font-bold tracking-tight">Dashboard</h1>
      <p className="mt-3 max-w-2xl text-muted-foreground">Your clinic overview at a glance — today's appointments, revenue, and pending tasks.</p>
      <div className="mt-8">
        <h2 className="text-lg font-semibold">How to create / use Dashboard</h2>
        <ol className="mt-3 list-decimal space-y-2 pl-5 text-sm leading-relaxed text-foreground/90">
          <li>Open Dashboard from the sidebar — it is the first item under Navigation.</li><li>Check Today's Appointments — see count, upcoming tokens, and who is next.</li><li>Review Revenue & Quick Stats — today's collections, pending bills, and low-stock alerts.</li><li>Doctors and staff use it as the morning briefing — how many patients today, who is next, and what needs attention.</li>
        </ol>
      </div>
      ...
      <div className="mt-4 rounded-lg border px-4 py-3 text-sm">
        <span className="font-semibold">Tip:</span> Open this from the app sidebar → Dashboard. If you do not see it, your role may not have access — ask your clinic admin.
      </div>
    </div>
  );
}
