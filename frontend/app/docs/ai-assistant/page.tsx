...
export const metadata: Metadata = {
  ...
  description: "Your 24/7 WhatsApp front desk that books appointments.",
};
export default function Page() {
  return (
    <div className="px-6 py-10 lg:px-10">
      <h1 className="font-heading text-3xl font-bold tracking-tight">AI Assistant</h1>
      <p className="mt-3 max-w-2xl text-muted-foreground">Your 24/7 WhatsApp front desk that books appointments.</p>
      <div className="mt-8">
        <h2 className="text-lg font-semibold">How to create / use AI Assistant</h2>
      ...
      <div className="mt-4 rounded-lg border px-4 py-3 text-sm">
        <span className="font-semibold">Tip:</span> Open this from the app sidebar → AI Assistant. If you do not see it, your role may not have access — ask your clinic admin.
      </div>
    </div>
  );
}
