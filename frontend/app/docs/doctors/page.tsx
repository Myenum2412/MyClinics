...
export const metadata: Metadata = {
  ...
  description: "Add doctors, specialities, and working hours.",
};
export default function Page() {
  return (
    <div className="px-6 py-10 lg:px-10">
      <h1 className="font-heading text-3xl font-bold tracking-tight">Doctors</h1>
      <p className="mt-3 max-w-2xl text-muted-foreground">Add doctors, specialities, and working hours.</p>
      <div className="mt-8">
        <h2 className="text-lg font-semibold">How to create / use Doctors</h2>
        <ol className="mt-3 list-decimal space-y-2 pl-5 text-sm leading-relaxed text-foreground/90">
          <li>Open Doctors → Add Doctor → enter name, speciality (e.g., Cardiology), and phone.</li><li>Set working hours and days — e.g., Mon-Sat 10 AM–2 PM — and assign to departments.</li><li>Save — patients can now book the right doctor at the right time and see availability live.</li>
        </ol>
      </div>
      ...
      <div className="mt-4 rounded-lg border px-4 py-3 text-sm">
        <span className="font-semibold">Tip:</span> Open this from the app sidebar → Doctors. If you do not see it, your role may not have access — ask your clinic admin.
      </div>
    </div>
  );
}
