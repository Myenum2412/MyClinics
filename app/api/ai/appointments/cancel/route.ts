...
import { cancelAppointment } from "@/services/ai/appointment.service";
import { cancelAppointmentSchema } from "@/services/ai/schemas";
...
export async function POST(request: Request) {
  ...
  const parsed = cancelAppointmentSchema.safeParse(body.data);
  if (!parsed.success) {
