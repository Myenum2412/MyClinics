...
import { ReportsUploadDialog } from "@/components/reports-upload-dialog";
import { ReportsFileDialog } from "@/components/reports-file-dialog";
import {
  fileCategory,
  fileCategoryColor,
  FileTypeIcon,
  ...
  return (
    <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
              ...
              {visibleFiles.map((file) => {
                ...
                return (
                  <div
                    ...
                    onKeyDown={(e) => {
                      if (e.key === "Enter") setViewing(file);
                    }}
                    className={cn(
      ...
      <ReportsUploadDialog
        ...
        defaultPatientId={
          activePatient === "all" || activePatient === "none"
            ? null
            : activePatient
        }
        defaultCategory={activeCategory === "all" ? "upload" : activeCategory}
        onUploaded={(newFiles) => {
